...
export function LeadQuickActions({
  ...
  return <Sheet open={open} onClose={onClose} title={`Actions · ${person}`}>
    ...
    <div className="mt-3 grid grid-cols-2 gap-2">
      <CallButton person={person} phone={phone} dealValue={dealValue} variant="primary" onBegin={onClose} />
      ...
      <CallButton person={person} phone={phone} dealValue={dealValue} label="Brief me" onBegin={onClose} />

...
export const TODO_PREVIEW_ITEMS: TodoAssignmentPreview[] = [
  ...
  { id: 'todo-p2', title: 'Send the parent reference to Rahul', assignees: ['Asha Thomas'], dueLabel: '1 hour ago', dueAt: dueAt(0, Math.max(0, new Date().getHours() - 1)), overdue: true, priority: 'high', status: 'open', createdBy: 'Meera Nair', link: { kind: 'conversation', id: 'conv-rahul', label: 'Rahul Das' }, sample: true },
